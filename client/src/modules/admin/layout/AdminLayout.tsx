...
export default function AdminLayout() {
  ...
  const navigation = [
    ...
    { name: 'Departments & Courses', href: '/admin/departments' },
    { name: 'Financial Overview', href: '/admin/finance' },
  ];
    ...
    <div className="min-h-screen flex bg-gray-100">
      ...
      <aside className="w-64 bg-gray-900 text-white shadow-md flex flex-col">
        <div className="h-16 flex items-center justify-center border-b border-gray-800">
          <Link to="/" className="text-xl font-bold text-white">Admin ERP</Link>
        </div>
        ...
        <div className="p-4 border-t border-gray-800">
          <ActionButton 
            onClick={logout} 
            className="w-full text-left px-4 py-2 text-red-400 hover:bg-gray-800 hover:text-red-300 rounded-md transition-colors font-medium"
          >
            Logout
          </ActionButton>
        </div>
      ...
      <main className="flex-1 flex flex-col">
        ...
        <header className="h-16 bg-white shadow-sm flex items-center justify-between px-8">
          ...
          <div className="flex items-center space-x-4">
            ...
            <span className="text-gray-700 font-medium">System Admin</span>
          </div>
        </header>
